...
/* this is a slightly modified version of the library above (cvector_vector_type was renamed to cvector_t) */
...
/**
 * @brief cvector_t - The vector type used in this library
 */
